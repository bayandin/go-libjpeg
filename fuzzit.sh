...
wget -q -O fuzzit https://github.com/fuzzitdev/fuzzit/releases/download/v2.4.62/fuzzit_Linux_x86_64
chmod a+x fuzzit
...
TYPE="$1"
./fuzzit create job --type "${TYPE}" --args "-dict=fuzzing.dict -close_fd_mask=3" bayandin/go-libjpeg fuzzer.tar.gz
